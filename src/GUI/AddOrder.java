...
public class AddOrder extends javax.swing.JInternalFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (r == 0) {
            ...
            try {
                if (rs.next()) {
                    ResultSet rsc = search("SELECT * FROM meal WHERE meal.date = '"+date+"' && meal.ward_master_id = '" + rs.getString("ward_id") + "'");

                    if (rsc.next()) {
                        JOptionPane.showMessageDialog(this, "This ward details are already in system", "Warning", JOptionPane.WARNING_MESSAGE);
                    } else {

                        if (1 == iud("INSERT INTO `meal` (`date`, `created_time`, `user_master_id`, `ward_master_id`)"
                                + " VALUES ('" + date + "', NOW(), '" + userId + "', '" + rs.getString("ward_id") + "');")) {

                            ResultSet rs1 = search("SELECT MAX(meal_id) AS meal_id FROM meal");

                            if (rs1.next()) {

                                String meal_id = rs1.getString("meal_id");

                                iud("INSERT INTO `meal_item` (`diet_type`, `qty`, `meal_master_id`) VALUES ('no_diet', '" + jTextField1.getText() + "', '" + meal_id + "');");
                                iud("INSERT INTO `meal_item` (`diet_type`, `qty`, `meal_master_id`) VALUES ('1_diet', '" + jTextField3.getText() + "', '" + meal_id + "');");
                                iud("INSERT INTO `meal_item` (`diet_type`, `qty`, `meal_master_id`) VALUES ('2_diet', '" + jTextField5.getText() + "', '" + meal_id + "');");
                                iud("INSERT INTO `meal_item` (`diet_type`, `qty`, `meal_master_id`) VALUES ('3_diet', '" + jTextField4.getText() + "', '" + meal_id + "');");
                                iud("INSERT INTO `meal_item` (`diet_type`, `qty`, `meal_master_id`) VALUES ('4_diet', '" + jTextField6.getText() + "', '" + meal_id + "');");
                                iud("INSERT INTO `meal_item` (`diet_type`, `qty`, `meal_master_id`) VALUES ('3_ld', '" + jTextField8.getText() + "', '" + meal_id + "');");
                                iud("INSERT INTO `meal_item` (`diet_type`, `qty`, `meal_master_id`) VALUES ('S1', '" + jTextField7.getText() + "', '" + meal_id + "');");
                                iud("INSERT INTO `meal_item` (`diet_type`, `qty`, `meal_master_id`) VALUES ('S2', '" + jTextField9.getText() + "', '" + meal_id + "');");
                                iud("INSERT INTO `meal_item` (`diet_type`, `qty`, `meal_master_id`) VALUES ('S3', '" + jTextField10.getText() + "', '" + meal_id + "');");
                                ...
                                for (int x = 0; jTable2.getRowCount() > x; x++) {
                                    ...
                                    if (rs2.next()) {
                                        ...
                                        iud("INSERT INTO `meal_extra_item` (`food_master_id`, `qty`, `meal_master_id`) VALUES ('" + rs2.getString("food_id") + "', '" + jTable2.getValueAt(x, 2) + "', '" + meal_id + "');");
